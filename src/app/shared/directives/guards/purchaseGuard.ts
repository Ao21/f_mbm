...
// 				this._canActivate.complete();
// 				this.router.navigate(['/confirmation']);
// 			} else if (next.reference && next.purchased === undefined) {
// 				this.paymentService.convertQuote(next.reference)
// 					.subscribe((convertedQuote) => {
// 						this.dataStore.convertQuote(convertedQuote.json());
